...
var I,integ,err
class CompoTrap extends Component {
    ...
    CTrap(a,b,n) {
        var h = (b-a)/n;
         I = (h/3)*(this.fx(a)+this.fx(b)+2*this.sumfx(1,n,h));
         integ = this.Inte(a,b);
    ...
    render() {
        return (
            <div className="Integration" >
                <h1>Composite Trapzoidal Rule</h1>
                <div style={{ padding: "50px 200px 200px" }} id="Graph">
                    ...
                    <Button variant="outline-primary" onClick={() => this.CTrap(parseInt(this.state.a),parseInt(this.state.b),parseInt(this.state.n))}>Submit</Button>
                    <br /><br />
